    ...
    : QAbstractListModel(parent)
{
    ...
    roles[DateRole] = "date";
    roles[NameRole] = "name";
    roles[LengthOfDay] = "lengthOfDay";
    roles[RiseTime] = "riseTime";
    roles[SetTime] = "setTime";
    roles[RiseCivilTime] = "riseCivilTime";
    roles[SetCivilTime] = "setCivilTime";
    roles[RiseNauticalTime] = "riseNauticalTime";
    roles[SetNauticalTime] = "setNauticalTime";
    roles[RiseAstronomicalTime] = "riseAstronomicalTime";
    roles[SetAstronomicalTime] = "setAstronomicalTime";
    roles[NoonTime] = "noonTime";
    roles[EquationOfTime] = "equationOfTime";
    setRoleNames(roles);

    m_type = Offical;

    //qDebug() << "!!! " << QDateTime::currentDateTime().secsTo(QDateTime::currentDateTimeUtc());
...
void SunRiseSetModel::setObj(const QVariant &data)
{
    qDebug() << this;
    qDebug() << data;
}
